					...
					for (int y = 0 ; y < height ; y++) {
						for (int z = 0 ; z < depth ; z++) {
							if(matrice[x][y][z] != null && (
									x == width - 1 || x == 0 || matrice[x + 1][y][z] == null || matrice[x - 1][y][z] == null
									|| y == height - 1 || y == 0 || matrice[x][y + 1][z] == null || matrice[x][y - 1][z] == null
									|| z == depth - 1 || z == 0 || matrice[x][y][z + 1] == null || matrice[x][y][z - 1] == null)) {
